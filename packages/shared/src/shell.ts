...
const PATH_CAPTURE_START = "__HELIOS_PATH_START__";
const PATH_CAPTURE_END = "__HELIOS_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__HELIOS_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__HELIOS_ENV_${name}_END__`;
}

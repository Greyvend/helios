...
import { DEFAULT_UNIFIED_SETTINGS } from "@helios-dev/contracts/settings";
...
function getProviderSummary(provider: ServerProvider | undefined): {
  ...
  if (!provider.enabled) {
    return {
      headline: "Disabled",
      detail:
        provider.message ?? "This provider is installed but disabled for new sessions in Helios.",
    };
  }
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
            <SettingsSection title="General">
              <SettingsRow
                title="Theme"
                description="Choose how Helios looks across the app."
                resetAction={
                  theme !== "system" ? (

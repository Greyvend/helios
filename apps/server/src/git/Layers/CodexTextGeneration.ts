...
import { CodexModelSelection } from "@helios-dev/contracts";
import { normalizeCodexModelOptions } from "@helios-dev/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `helios-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(

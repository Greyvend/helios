...
import { makeDrainableWorker } from "@helios-dev/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.HELIOS_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
